...
public class Graph_1YT {
	...
	public static void sourceToPath(ArrayList<Edge> graph[], boolean vis[], int src, String path, int tar) {
		if (src == tar) {
...
//		boolean chechNodesareConnectedOrNot = chechNodesareConnectedOrNot(0, 5, v, graph);
//		System.out.println(chechNodesareConnectedOrNot);
//     bfs(graph, v);
//     System.out.println();
...
//     }
	...
	//Day-61 Anand sir
	// Check nodes are conntected or not
	private static boolean chechNodesareConnectedOrNot(int i, int j, int v, ArrayList<Edge>[] graph) {
		Queue<Integer> q = new LinkedList<Integer>();
